...
const chalk_1 = __importDefault(__nccwpck_require__(656));
const formatting_1 = __nccwpck_require__(443);
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(713);
	}
...
const ansiStyles = __nccwpck_require__(839);
const {stdout: stdoutColor, stderr: stderrColor} = __nccwpck_require__(606);
const {
	stringReplaceAll,
...
const chalkTag = (chalk, ...strings) => {
	...
	if (template === undefined) {
		template = __nccwpck_require__(655);
	}
...
const cssKeywords = __nccwpck_require__(272);
...
const route = __nccwpck_require__(821);
...
const hasFlag = __nccwpck_require__(761);
