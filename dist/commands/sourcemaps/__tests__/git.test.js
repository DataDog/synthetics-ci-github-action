...
const git_1 = __nccwpck_require__(5959);
describe('git', () => {
    describe('gitRemote', () => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TrackedFilesMatcher = exports.getRepositoryData = exports.gitTrackedFiles = exports.stripCredentials = exports.gitRemote = exports.newSimpleGit = void 0;
const fs_1 = __importDefault(__nccwpck_require__(5747));
const simpleGit = __importStar(__nccwpck_require__(1477));
const url_1 = __nccwpck_require__(8835);
const renderer_1 = __nccwpck_require__(4115);
...
const getRepositoryData = (git, stdout, repositoryURL) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        stdout.write(renderer_1.renderGitWarning(e));
        return undefined;
    }
    const data = {
        hash,
...
class TrackedFilesMatcher {
    ...
    matchSourcemap(stdout, srcmapPath) {
        ...
        if (filtered.length === 0) {
            stdout.write(renderer_1.renderSourcesNotFoundWarning(srcmapPath));
            return undefined;
        }
        return filtered;
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.renderUpload = exports.renderCommandInfo = exports.renderSuccessfulCommand = exports.renderRetriedUpload = exports.renderFailedUpload = exports.renderInvalidPrefix = exports.renderConfigurationError = exports.renderSourcesNotFoundWarning = exports.renderGitDataNotAttachedWarning = exports.renderGitWarning = void 0;
const chalk_1 = __importDefault(__nccwpck_require__(6656));
const formatting_1 = __nccwpck_require__(2443);
const upload_1 = __nccwpck_require__(5022);
const utils_1 = __nccwpck_require__(3077);
...
const form_data_1 = __importDefault(__nccwpck_require__(1829));
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(2713);
	}
...
const ansiStyles = __nccwpck_require__(3839);
const {stdout: stdoutColor, stderr: stderrColor} = __nccwpck_require__(5606);
const {
	stringReplaceAll,
...
const chalkTag = (chalk, ...strings) => {
	...
	if (template === undefined) {
		template = __nccwpck_require__(8655);
	}
...
const cssKeywords = __nccwpck_require__(8272);
...
const conversions = __nccwpck_require__(7680);
const route = __nccwpck_require__(1821);
...
var populate = __nccwpck_require__(6123);
...
const hasFlag = __nccwpck_require__(8761);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(8452);
